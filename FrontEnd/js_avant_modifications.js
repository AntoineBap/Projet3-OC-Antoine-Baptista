...
//   // Recuperation des 'works' apres avoir eu le login
...
//   // creation et assignation de chaque work a une img
//   .then((data) => {
//     console.log(data);
...
// // creation des boutons de filtres de la page d'accueil
// function createFilterBtn(categories) {
//   const filterBar = document.getElementById("filterbar");

//   // creation d'un filtre 'tous' (non disponible dans l'api)
...
//   // creation des boutons filtres provenants de l'api /categories
...
//     .then((response) => response.json())
//     .then((works) => {
//       // operation ternaire pour filtrer les works selon leur categoryId
...
// fonction d'affichage des works au sein de la modale
...
//Creation des categories dans le form de la modale pour l'ajout de photos
fetch(apiUrlCategories, {
  method: "GET",
  headers: {
    Authorization: `Bearer ${bearerToken}`,
